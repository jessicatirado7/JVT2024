...
tinify.fromFile('../demo-gradient/decoration-1.svg').toFile('../demo-gradient/decoration-1-compressed.svg');
...
tinify.fromFile('../images/demo-gradient/decoration-2.png').toFile('../images/demo-gradient/decoration-2-compressed.jpg');
...
tinify.fromFile('../images/demo-gradient/services/service-1.png').toFile('../images/demo-gradient/services/service-1-compressed.jpg');
tinify.fromFile('../images/demo-gradient/services/service-2.png').toFile('../images/demo-gradient/services/service-2-compressed.jpg');
tinify.fromFile('../images/demo-gradient/services/service-3.png').toFile('../images/demo-gradient/services/service-3-compressed.jpg');
tinify.fromFile('../images/demo-gradient/services/service-4.png').toFile('../images/demo-gradient/services/service-4-compressed.jpg');
...
tinify.fromFile('../images/demo-gradient/section-image-5.png').toFile('../images/demo-gradient/section-image-5-compressed.jpg');
...
tinify.fromFile('../images/demo-gradient/bg-shape-1.svg').toFile('../images/demo-gradient/bg-shape-1-compressed.jpg');
tinify.fromFile('../images/demo-gradient/decoration-1.svg').toFile('../images/demo-gradient/decoration-1-compressed.jpg');
